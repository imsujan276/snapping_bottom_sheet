...
class SnapSpec {
  /// If true, the [SnappingBottomSheet] will snap to the provided [snappings].
  /// If false, the [SnappingBottomSheet] will slide from minExtent to maxExtent
  /// and then begin to scroll.
  final bool snap;

  /// The snap extents for a [SnappingBottomSheet].
  ///
  /// The minimum and maximum values will represent the thresholds in which
  /// the [SnappingBottomSheet] will slide. When the child of the sheet is bigger
  ...
  ///
  /// On a [SnappingBottomSheet] this will correspond to the initial extent of the
  /// sheet. On a [SnappingBottomSheetDialog] this will be the first extent that
  ...
  /// Creates an object that defines how a [SnappingBottomSheet] should snap, or if it should at all.
  const SnapSpec({
    this.snap = true,
  ...
  /// The snap extent that makes header and footer fully visible without account for vertical padding on the [SnappingBottomSheet].
  static const double headerFooterSnap = -1;

  /// The snap extent that makes the header fully visible without account for top padding on the [SnappingBottomSheet].
  static const double headerSnap = -2;

  /// The snap extent that makes the footer fully visible without account for bottom padding on the [SnappingBottomSheet].
  static const double footerSnap = -3;

  /// The snap extent that expands the whole [SnappingBottomSheet]
...
class ParallaxSpec {
  ...
  /// to the body of the [SnappingBottomSheet].
  final bool enabled;

  /// A fractional ([0..1]) value that determines the intensity of
  /// the parallax effect.
  ///
  /// For example, a value of 0.5 would mean that the body of the [SnappingBottomSheet]
  /// would be moved with half the speed of the [SnappingBottomSheet].
  final double amount;
  ...
  ///
  /// If endExtent is null, the [SnappingBottomSheet] will use the penultimate extent on the `snappings` array
