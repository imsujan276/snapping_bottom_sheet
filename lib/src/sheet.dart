...
class SnappingBottomSheet extends StatefulWidget {
  ...
  ///
  /// Usually set for large screens. By default the [SnappingBottomSheet]
  ...
  /// the [SnappingBottomSheet] faster than the [body] the depth effect is achieved.
  /// {@endtemplate}
  ...
  // * SnappingBottomSheetDialog fields

  /// private, do not use!
  // ignore: public_member_api_docs
  final _SnappingBottomSheetRoute? route;

  /// {@template sliding_sheet.isDismissable}
  /// If false, the `SnappingBottomSheetDialog` will not be dismissable.
  ///
  ...
  @override
  SnappingBottomSheetState createState() => SnappingBottomSheetState();
}

class SnappingBottomSheetState extends State<SnappingBottomSheet>
  ...
  late final _SnappingBottomSheetScrollController controller;
  ...
  @override
  void didUpdateWidget(SnappingBottomSheet oldWidget) {
...
/// A data class containing state information about the [SnappingBottomSheet]
...
class SheetState {
  ...
  /// Whether the [SnappingBottomSheet] has reached its maximum extent.
  final bool isExpanded;

  /// Whether the [SnappingBottomSheet] has reached its minimum extent.
  final bool isCollapsed;

  /// Whether the [SnappingBottomSheet] has a [scrollOffset] of zero.
  final bool isAtTop;

  /// Whether the [SnappingBottomSheet] has reached its maximum scroll extent.
...
class SheetController {
  /// Inherit the [SheetController] from the closest [SnappingBottomSheet].
  ///
  /// Every [SnappingBottomSheet] has a [SheetController], even if you didn't assign
  ...
  static SheetController? of(BuildContext context) {
    return context
        .findAncestorStateOfType<SnappingBottomSheetState>()
        ?.sheetController;
  }
  ...
  ///
  /// This function can be used to reflect changes on the [SnappingBottomSheet]
  ...
  /// Reveals the [SnappingBottomSheet] if it is currently hidden.
  ...
  /// The current [SheetState] of this [SnappingBottomSheet].
