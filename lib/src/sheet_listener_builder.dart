...
/// of a [SnappingBottomSheet].
///
/// This is useful to implementing custom transitions for the [SnappingBottomSheet].
class SheetListenerBuilder extends StatefulWidget {
  /// A callback that gets invoked whenever the [SheetState] of the [SnappingBottomSheet]
