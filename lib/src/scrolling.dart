...
/// A widget that can be used to implement a bottom sheet that snaps to specific
///
/// This widget is similar to the [BottomSheet] widget, but allows to snap to
/// specific extents.
///
/// The [SnappingBottomSheet] can be used to implement a bottom sheet that
/// snaps to specific extents.
class _SheetExtent {
  final bool isDialog;
  final _SnappingBottomSheetScrollController? controller;
...
/// Snapping bottom sheet controller
///
/// This controller can be used to control the [SnappingBottomSheet] programmatically.
class _SnappingBottomSheetScrollController extends ScrollController {
  final SnappingBottomSheetState sheet;
  _SnappingBottomSheetScrollController(this.sheet);

  SnappingBottomSheet get widget => sheet.widget;
  ...
  _SnappingBottomSheetScrollPosition? _currentPosition;
  ...
  @override
  _SnappingBottomSheetScrollPosition createScrollPosition(
    ScrollPhysics physics,
    ScrollContext context,
    ScrollPosition? oldPosition,
  ) {
    return _currentPosition = _SnappingBottomSheetScrollPosition(
      this,
      physics: physics,
      context: context,
...
/// A widget that can be used to implement a bottom sheet that snaps to specific
/// extents.
class _SnappingBottomSheetScrollPosition
    extends ScrollPositionWithSingleContext {
  final _SnappingBottomSheetScrollController scrollController;
  _SnappingBottomSheetScrollPosition(
  ...
  SnappingBottomSheetState get sheet => scrollController.sheet;
    ...
    void _tick() {
      ...
      if (shouldStopOnUpFling || shouldStopOnDownFling) {
        ...
        velocity = ballisticController.velocity +
            (Tolerance.defaultTolerance.velocity *
