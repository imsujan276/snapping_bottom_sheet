...
///
/// The `builder` parameter must not be null and is used to construct a [SnappingBottomSheetDialog].
///
...
Future<T?> showSnappingBottomSheet<T>(
  BuildContext context, {
  required SnappingBottomSheetDialog Function(BuildContext context) builder,
  Widget Function(BuildContext context, SnappingBottomSheet sheet)?
      parentBuilder,
  RouteSettings? routeSettings,
  bool useRootNavigator = false,
  bool resizeToAvoidBottomInset = true,
}) {
  SnappingBottomSheetDialog dialog = builder(context);
      ...
      builder: (context, animation, route) {
        return ValueListenableBuilder(
          ...
          builder: (context, dynamic value, _) {
            ...
            Widget sheet = SnappingBottomSheet._(
              route: route,
            ...
            if (parentBuilder != null) {
              sheet = parentBuilder(context, sheet as SnappingBottomSheet);
            }
...
class SnappingBottomSheetDialog {
  ...
  /// Creates a wrapper class to show a [SnappingBottomSheet] as a bottom sheet dialog.
  const SnappingBottomSheetDialog({
    this.builder,
    this.customBuilder,
    this.headerBuilder,
    this.footerBuilder,
...
class _SnappingBottomSheetRoute<T> extends PageRoute<T> {
  final Widget Function(
      BuildContext, Animation<double>, _SnappingBottomSheetRoute<T>) builder;
  final Duration duration;
  _SnappingBottomSheetRoute({
